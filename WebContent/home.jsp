...
<div class = "posts">
		<c:forEach items = "${posts}" var = "post">
			...
			<div class = "post">
				...
				<c:if test = "${(loginUser.branchId).equals('1') && (loginUser.departmentId).equals('2') || (loginUser.departmentId).equals('3') && (comment.departmentId).equals('4') && (loginUser.branchId).equals(comment.branchId)}">
